...
The current release is **nsevt 1.2.0**. Install the exact version with
`pip install nsevt==1.2.0`. Every release is archived under the
...
DOI for 1.2.0 is recorded here once Zenodo mints it.
